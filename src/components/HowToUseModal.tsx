...
import { Box, Button, Divider, Grid, IconButton, Link, List, ListItem, ListItemText, Modal, Paper, Typography } from "@mui/material";
...
const HowToUseModal: React.FC<HowToUseProps> = ({ open, onClose, onApplyCondition }) => {
